...
#DOUBLE CHECK ALL POSSIBLE OUTCOMES FOR SMP, LDP, AND CHECK FOR THE DEATH ENDING BEFORE REACHING GAME OVER, AND FINISHING GAME WITHOUT DEATH FOR BOTH CHECK INDENTING FOR SMP TOO.
