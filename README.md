...
- **SOC_Log_Triage.py**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               A Python tool to analyze SSH and firewall logs, detect suspicious IP activity, and categorize IPs into Blocked, Escalate, or Double-check groups based on configurable thresholds.  
...
### For **Log_Parse_Analysis.py**
- Place your log CSV in the 'data/' folder **relative to where this script is located**. 
